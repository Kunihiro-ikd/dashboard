...
def img_upload(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            transfer_gray(uploaded_file_url, gray_path)
...
def transfer_gray(uploaded_file_url, gray_path):
...
def nueral_style_transfer(request):
    template_name = 'nueral_style_transfer.html'
    form = DocumentForm(request.POST, request.FILES)
